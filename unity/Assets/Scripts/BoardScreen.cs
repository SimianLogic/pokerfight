...
public class BoardScreen : GameScreen
{
	...
	override public void willShow()
	{
		...
		//BOGUS McBOGUSON
		setText("p1_defense_level","1");		
		setText("p1_attack_level","1");
		setText("p1_attack","24");
		setText("p1_health","80");
		setText("p1_defense","4");
		setText("p1_initiative","30");
		
		setText("p2_defense_level","1");
		setText("p2_attack_level","1");
		setText("p2_attack",""+RXRandom.Range (4,24));
		setText("p2_health",""+RXRandom.Range (35,120));
